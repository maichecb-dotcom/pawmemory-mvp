...
function buildInstructions(pet, memories) {
  return [
    ...
    "Use warm, concrete behavioral descriptions: posture, small habits, favorite places, routine, and sensory memories.",
    "Keep replies short: 2 to 5 gentle sentences. Avoid long explanations, therapy jargon, and dramatic language.",
